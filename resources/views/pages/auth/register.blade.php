...
@section('content')
    <section id="signup" style="background-image: url('/assets/images/auth-background.avif')">
                ...
                <div class="col-12 col-lg-5 mt-4">
                    <div class="row">
                        ...
                        @csrf
                            ...
                            <button type="submit" class="btn btn-lg btn_auth btn-block mt-2 w-100">Daftar</button>
                            <p class="text-center mt-4">Atau daftar dengan Google</p>
                            <a href="{{ route('auth-google') }}" class="btn btn-lg btn_google_auth btn-block mt-2 w-100 d-flex align-items-center justify-content-center"><img class="me-2" src="/assets/images/google-logo.png" alt="logo Google"><span>Google</span></a>
                        </form>
                    </div>
